import { Shield, Plane, Wrench, Package, AlertTriangle, Brain, Rocket, Database, Lock, Signal, ChartBar, Globe, Cpu } from "lucide-react";
    ...
    <div className="min-h-screen bg-navy-dark text-white">
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col">
          <header className="bg-steel-dark p-6 border-b border-steel">
            <div className="flex items-center justify-between">
              <h1 className="text-2xl font-bold">Guardian-IO Command Center</h1>
              <div className="flex items-center gap-4">
                <button className="p-2 hover:bg-steel rounded-lg">
